...
B_N_Udata = size(ScaledUdata,1);
u=.9;
[trainUset,testUset, trainUlabels, testUlabels] = sepratedata(ScaledUdata,u);

ScaledUdata = [trainUset,trainUlabels];
B_N_Ndata = size(ScaledUdata,1);
B_N_Pdata = size(ScaledTrain,1);
